...
function includes() {
    ...
    $first_internal_includes = [ 'functions', 'crypt', 'options', 'payments', 'structure', 'alerts', 'arrays', 'data', 'elements', 'files', 'icons', 'language', 'modules', 'options', 'spreadsheet', 'user', 'log' ];
