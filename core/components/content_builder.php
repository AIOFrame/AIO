...
pre( '', 'aio_content_builder' );
    ...
    post();
    el( 'button', 'add_button', '+', '', 'data-on=".choose_widgets_modal" data-add-col' );
    ...
    pre( 'aio_cb_templates', 'aio_cb_templates', 'div', 'style="display: none"' );
        ...
        div( '', _div( 'widget_set', $widget_head . $widget_body ), '', 'data-widget-template data-data' );
        // Rows Template
        ...
        $row_body = _div( 'row', '{{col}}', '', 'data-body' );
        div( '', _div( 'row_set', $row_head . $row_body ), '', 'data-row-template' );
        // Column Template
        div( '', _div( 'col', '{{widget}}', '', 'data-col' ), '', 'data-col-template' );
        // Add Button Template
