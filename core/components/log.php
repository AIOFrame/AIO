...
if( $file = fopen( $file, 'r' ) ) {
    ...
    <head>
        ...
        get_styles(['bootstrap/grid','log','micro']);
        font(['Lato', '300,500']); ?>
    </head>
    ...
    <header>
        ...
        <div class="options">
            ...
            <div onclick="process_data(this)" data-action="<?php $cry->enc('clear_log_ajax'); ?>" class="ico delete clear"><i class="tip">Clear all Log</i></div>
    ...
    <aside>
        <div class="filters scroll">
            <div class="type p15">
                <label class="ttu"><?php E('Filter by Type'); ?></label>
    ...
    <article id="aio_log">
        <div class="filters_wrap">
            ...
            <div class="filters">
                ...
                $f->checkboxes( 'type', '', $types, '', '', 0, '', '', 'fww', 0 );
                ?>
            </div>
        </div>
    ...
    <?php get_scripts(['basics','data','clipboard','log']); ?>
    <div id="notification">
        <h4 class="title"></h4>
        <div class="close"></div>
