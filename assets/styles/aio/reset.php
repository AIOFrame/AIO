...
if( isset( $_GET['scrollbar'] ) ) {
    //$reset = str_replace( 'bar { width:12px; height:12px; }', 'scrollbar { width:'.$_GET['scrollbar'].'px; height:'.$_GET['scrollbar'].'px; }', $reset );
    $reset = str_replace( 'scrollbar{width:12px;height:12px}', 'scrollbar{width:'.$_GET['scrollbar'].'px;height:'.$_GET['scrollbar'].'px}', $reset );
}
